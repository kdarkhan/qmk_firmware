...
[0] = LAYOUT(
  ...
  LT(2, KC_ESC),  KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                         KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,   LT(2, KC_BSPC),
...
[2] = LAYOUT(
  ...
  KC_LSFT,  KC_PSCR,  _______,  _______,  _______, _______,                      KC_LEFT,    KC_DOWN,  KC_UP,    KC_RGHT, _______,  KC_DEL,
